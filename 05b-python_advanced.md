...
>> There are 8 different degrees with varying frequencies. PH.D degrees being the most frequent.
```
Ph.D: 31
Sc.D: 6
MPH: 2
...
>> There are 3 different titles within the faculty.csv and their frequencies are very close in value:
```
...
>> [(('Scarlett', 'Bellamy'),
    ('ScD','Associate Professor of Biostatistics','bellamys@mail.med.upenn.edu')),
    (('Warren', 'Bilker'),
